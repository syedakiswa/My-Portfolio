...
//       }}
//     >
//  <div className="relative w-full h-full bg-purple-500 rounded-full blur-3xl opacity-30 transition-transform duration-500 ease-in-out hover:scale-x-125 transform"></div>
