...
const Navbar = () => {
  ...
  // change scroll and change navbar  background
    ...
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md " : "bg-transparent"
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='text-lg font-semibold cursor-pointer'>
          ...
          <span className='text-[#8245ec]'>/</span>
          <span className='text-white'>Kiswa</span>
          <span className='text-[#8245ec]'>&gt;</span>
        </div>
        ...
        <div className='hidden md:flex space-x-4'>
          <a href="https://github.com/syedakiswa" target='_blank' rel="noopener noreferrer"className='text-gray-300 hover:text-[#8245ec]'>
            <FaGithub size={24} />
          </a>

          <a href="https://www.linkedin.com/in/tarun-kaushik-553b44la4"
            target='_blank'
        ...
        {isOpen && (
          <div className='absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 z-50 rounded-xl shadow-2xl bg-[#050414]/60 backdrop-blur-md'>
